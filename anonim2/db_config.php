...
//Domini considerati come 'esterni'
$external_domains = array('gmail.com' => 'EXT1', 'hotmail.it' => 'EXT2');
...
$default_mandatory = array(); 

if(!(array_search($field_to_anonymize, $default_checked) === false)) $default_checked[] = $field_to_anonymize;
if(!(array_search($field_to_anonymize, $default_mandatory) === false)) $default_mandatory[] = $field_to_anonymize;
if(!(array_search($msg_id_name, $default_checked) === false)) $default_checked[] = $msg_id_name;
if(!(array_search($msg_id_name, $default_mandatory) === false)) $default_mandatory[] = $msg_id_name;
